...
export const ColorList = {
  ...
  textOnSecondary: '#757575',         // Medium grey for text on secondary background
  
  // Heatmap Colors
  heatmapLight: '#B2E2E2',            // Adjusted light end of the heatmap spectrum to match the accent
  heatmapDark: '#065A82',             // Adjusted dark end of the heatmap spectrum to complement the primaryDark
};