...
export default function MiniHeader({ label, explanation }) {
  ...
  return (
    <View style={styles.headerContainer}>
      ...
      <TouchableOpacity onPress={handlePress} style={[styles.infoButton, showExplanation && styles.infoButtonActive]}>
