...
export default function FeedScreen({ navigation }) {
  ...
  const featureImpactMessages = [
    "Age range: 25-34",
    "Recent browsing: tech",
    "Interests: politics",
    "Interests: cats",
    "Location: urban",
    "Reading time: 5-10 min",
    "Browsing: science",
    "Category: health, cats",
    "Popular with peers",
                  ...
                  >
                    ...
                    {article.tfidfScore && (
                      ...
                      >
                        ...
                        /> */}
                        <Text style={styles.themeTitle}>Key reasons: </Text>
                                ...
                                <View
                                  style={[
                                    styles.tfidfBar,
                                    {
                                      ...
                                      width: `${score * 2}%`, // Proportional width based on score, scaled to 300%
                                    },
                                  ]}
                                />
                              </View>
